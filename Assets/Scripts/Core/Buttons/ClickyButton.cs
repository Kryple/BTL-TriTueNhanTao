...
public class ClickyButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    [SerializeField] private int _compressedClipID, _uncompresssedClipID;
    ...
    private void Awake() 
    {
        ...
        _compressedClip = _buttonResourcesList._compressedClips[_compressedClipID];
        _uncompressedClip = _buttonResourcesList._uncompressedClips[_uncompresssedClipID];
